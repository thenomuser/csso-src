...
ConVar cl_radar_scale( "cl_radar_scale", "1.5", FCVAR_ARCHIVE, "Sets the radar scale. Valid values are 0.25 to 2.0.", true, 0.25f, true, 2.0f );
...
void CCSMapOverview::PaintBackground()
{
	...
	if ( GetMode() == MAP_MODE_RADAR && m_bRoundRadar )
	{
		...
		surface()->DrawSetColor( 255, 255, 255, cl_radaralpha.GetInt());
