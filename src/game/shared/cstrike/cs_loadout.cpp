...
int CCSLoadout::GetBuySkins( CBasePlayer* pPlayer, int iWeaponId )
{
	int value = 0;
	...
	if (iTeamNumber == TEAM_CT)
	{
		switch ( iWeaponId )
		{
			//atoi( engine->GetClientConVarValue( engine->IndexOfEdict( pCSPlayer->edict() ), "loadout_slot_knife_weapon_t" ) );
			case WEAPON_P250:
