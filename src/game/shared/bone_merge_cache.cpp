...
void CBoneMergeCache::CopyFromFollow( const Vector followPos[], const Quaternion followQ[], int boneMask, Vector myPos[], Quaternion myQ[] )
{
	UpdateCache();
...
void CBoneMergeCache::CopyToFollow( const Vector myPos[], const Quaternion myQ[], int boneMask, Vector followPos[], Quaternion followQ[] )
{
	UpdateCache();
